...
public class Main_Multi extends Activity {
    ...
    private TextView txtQuestion, times, scored, player1, player2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        player1Name = getIntent().getExtras().get("user_name").toString();
        player2Name = getIntent().getExtras().get("other_user").toString();
    ...
    public void getAnswer(String AnswerString) throws InterruptedException {
        ...
        if (questionID < 20) {
            ...
            timer.cancel();
            active = false;
            Intent intent = new Intent(Main_Multi.this, ResultActivity.class);
            Bundle b = new Bundle();
